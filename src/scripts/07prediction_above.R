...
# extracting values by points
  ...
  cov_soil_land <- stack_above[[1:16]]
  ...
  save(cov_train, file = paste0("regression_matrix_above", ".RData"))
  ...
  # setwd(workspace)
  save(mod_fit, file = paste0("model_above", ".RData"), Overwrite = T)
...
# Plot and save variable importance and testing
  ...
  ggsave(filename = "variable_importance_above.png", width = 20, height = 10)
...
# setwd(workspace)
  ...
  path = "/workdir/data/workspace/yield_above"
