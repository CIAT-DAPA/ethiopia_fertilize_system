...
# extracting values by points
  ...
  cov_soil_land <- stack_below[[1:16]]
  ...
  save(cov_train, file = paste0("regression_matrix_below", ".RData"))
  ...
  # setwd(workspace)
  save(mod_fit, file = paste0("model_below", ".RData"), Overwrite = T)
...
# Plot and save variable importance and testing
  ...
  ggsave(filename = "variable_importance_below.png", width = 20, height = 10)
...
# setwd(workspace)
  ...
  path = "/workdir/data/workspace/yield_below"
