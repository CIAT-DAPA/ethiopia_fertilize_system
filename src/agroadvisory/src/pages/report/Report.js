...
function Report() {
    ...
    // const geo = GeoFeatures.geojson("'Qola Mulatu'");
    // console.log(geo);
    ...
    const SeasonalChartCarousel = () => {
        return(
            <div className='col mt-4' style={{backgroundColor: "white"}} key="donutCarousel">
                <h4>Seasonal</h4>
    ...
    const BarChart = (data, name) => {
        return(
            <div className='col mt-4' style={{backgroundColor: "white"}} key={name+"bar_chart"}>
                {/* <h4>{props.name}</h4> */}
                <ColumnChart/>
        ...
        <main>
            ...
            <section className='container'>
                ...
                <div className='row'>
                        ...
                        <BarChart data={1} name={"compost"}/>
                        <BarChart data={1} name={"urea"}/>
