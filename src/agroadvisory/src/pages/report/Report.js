...
function Report() {
    ...
    const Location = () => {
        return(
            <div className='col' style={{backgroundColor: "white"}} key="locationMap">
                    ...
                    {
                        geo && <Map id="location_report" init={map_init} type={"location_report"} geo={geo} style={{height: '40vh'}}/>
                    }
            </div>
    ...
    const SeasonalChartCarousel = () => {
        return(
            <div className='col-4 mt-4' style={{backgroundColor: "white"}} key="donutCarousel">
                <h4>Seasonal</h4>
